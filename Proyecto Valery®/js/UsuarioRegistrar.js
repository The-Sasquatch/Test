...
if(forma.nb_usuario.value == null || forma.nb_usuario.value == ''){
	alert('usuario es un campo obligatorio.'+mensaje)
	forma.nb_usuario.focus()
	return false
}
var numnb_usuario=forma.elements["nb_usuario"];
if(!sololetras(numnb_usuario.value)){
